...
-(void)initViewControllers {
	...
	self.browseRidesViewControllers = [NSArray arrayWithObjects:ridesVC, nil];
...
-(void)initCellTitles {
	...
	self.browseRidesSection = [NSArray arrayWithObjects:@"Rides", nil];
	self.addRidesSection = [NSArray arrayWithObjects:@"Add", @"Search", nil];
	self.profileSection = [NSArray arrayWithObjects:@"My Profile", @"My Rides", nil];
...
-(void)initCellIcons {
	...
	// removed getACar
	self.browseRidesIcons = [NSArray arrayWithObjects:@"DriverIconBig", nil];
...
-(void)addBackgroundToTableView {
	self.tableView.backgroundColor = [UIColor colorWithRed:0.325 green:0.655 blue:0.835 alpha:1];
