...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.readOptions = [[NSArray alloc] initWithObjects:@"Terms of Use", @"Privacy statement", @"Licenses", nil];
        self.readIcons = [[NSArray alloc] initWithObjects:[UIImage imageNamed:@"PrivacyIconBlack"], [UIImage imageNamed:@"PrivacyIconBlack"], [UIImage imageNamed:@"LicenseIconBlack"], nil];
...
//        [self.navigationController pushViewController:reminderVC animated:YES];
		...
		PrivacyViewController *termsVC = [[PrivacyViewController alloc] init];
		termsVC.title = @"Terms of Use";
		termsVC.privacyViewTypeEnum = Terms;
