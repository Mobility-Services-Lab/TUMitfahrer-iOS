...
- (void)back {
    if (self.shouldGoBackEnum == GoBackNormally) {
        ...
        RidesPageViewController *ridesVC = [[RidesPageViewController alloc] init];
        UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController:ridesVC];
...
-(void)initFields {
    ...
    if ([self.ride.rideType intValue] == ContentTypeCampusRides) {
        self.rideDetail.rideTypeLabel.text = @"Campus";
        self.rideDetail.rideTypeImageView.image = [UIImage imageNamed:@"CampusIcon"];
    } else {
        self.rideDetail.rideTypeLabel.text = @"Activity";
        self.rideDetail.rideTypeImageView.image = [UIImage imageNamed:@"ActivityIcon"];
    }
}
...
-(UIView *)prepareReasonViewWithTitle:(NSString *)title {
    ...
    reasonLabel.text = @"Please give a reason for cancelation";
    ...
    self.counterLabel.text = @"(optional)";
